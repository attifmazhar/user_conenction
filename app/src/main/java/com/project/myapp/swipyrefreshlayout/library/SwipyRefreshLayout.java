...
/*package com.project.bluetoothdataexchange.swipyrefreshlayout.library;
...
import com.project.bluetoothdataexchange.R;
...
//    private static final String LOG_TAG = SwipyRefreshLayout.class.getSimpleName();
    ...
    private static final int CIRCLE_BG_LIGHT = R.drawable.refreshround;//0xFFFAFAFA;
...
/*    public SwipyRefreshLayout(Context context, AttributeSet attrs) {
    ...
    private void createProgressView() {
        ...
        mCircleView.setImageDrawable(mProgress);
        mCircleView.setBackgroundResource(R.drawable.refreshroundv2);
        mCircleView.setVisibility(View.GONE);
        addView(mCircleView);
    }
...
/*    public void setProgressBackgroundColor(int colorRes) {
        ...
        mProgress.setBackgroundColor(ContextCompat.getColor(getContext(), colorRes));
    }
